        ...
        body: BlocConsumer<AppCubit, AppStates>(
          ...
          builder: (context, state) {
            ...
            return Conditional.single(
              ...
              cubit.subjectsModel != null,
              fallbackBuilder: (context) => DefaultLoader(),
              widgetBuilder: (context) => Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 22),
                    child: buildTitleHome(deviceInfo: deviceInfo, title: 'المواد'),
                  ),
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => TeacherSubjectsBuildItem(
                        title: cubit.subjectsModel!.subjects![index]
                            .name!,
                        onPressed: () {
                          navigateTo(context, TeacherTestsScreen(
                            deviceInfo: deviceInfo,
                            subjectId: cubit.subjectsModel!.subjects![index].id!,
                          ),
                          );
                        },
                      ),
