...
class IntroduceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      value: AuthCubit.get(context)..resetAccountType(),
                      ...
                      children: [
                        ...
                        BuildIntroduceItem(
                          ...
                          backgroundColorContainer:
                              cubit.isTeacher ? primaryColor : Colors.white,
                          onPressed: () {
                        ...
                        BuildIntroduceItem(
                          ...
                          deviceInformation: deviceInfo,
                          backgroundColorContainer:
                              cubit.isStudent ? primaryColor : Colors.white,
                          onPressed: () {
